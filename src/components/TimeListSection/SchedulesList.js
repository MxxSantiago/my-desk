...
export const SchedulesList = ({ schedules, setSchedules, swiperState }) => {
    const filteredPerDaySchedules = schedules.filter(_schedule => _schedule.day === swiperState);

    const orderedSchedules = arrayPropertiesFilter(filteredPerDaySchedules, "startTime");    
